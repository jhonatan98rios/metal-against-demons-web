...
export class SoundAttackLevel_5 implements AbstractSkill {
    ...
    constructor({ initialX, initialY, targetX, targetY, width, height, speed, damage, spritesheet }: ISoundAttackLevel_5) {
