...
export class SoundAttackLevel_4 implements AbstractSkill {
    ...
    constructor({ initialX, initialY, targetX, targetY, width, height, speed, damage, spritesheet }: ISoundAttackLevel_4) {
