...
export default function Navbar() {
  ...
  const buttonStyle = "mx-3 text-2xl font-extrabold text-white h-14 w-60 px-8 bg-slate-950 flex items-center justify-center rounded-xl"
  ...
  return (
    <nav className="w-screen h-20 bg-header-menu bg-no-repeat bg-cover bg-center z-10 fixed bottom-0 flex justify-center items-start border-t-4 border-t-gray-500">
      <div className="max-w-screen-lg mx-a w-4/5 -mt-10 bg-gradient-to-r from-gray-600 to-gray-300 rounded-xl flex justify-center items-start">

        <div className="flex items-center justify-center h-20 w-[calc(100%-8px)] bg-header-menu my-1 rounded-xl">
